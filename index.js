...
function addGamesToPage(games) {
    ...
    for (const game of games) {
      ...
      // *** make sure this path matches your folder layout ***
      // if your JSON's game.img is already "./assets/foo.png", you can use src="${game.img}"
      // otherwise build it yourself from the filename:
      const filename = game.img.split("/").pop();  
      card.innerHTML = `
        <img 
          class="game-img" 
          src="assets/${filename}" 
